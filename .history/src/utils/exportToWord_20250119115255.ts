    ...
    const doc = new Document({
      sections: [{
        properties: {
          page: {
            margin: {
              top: 800,      // 增加顶部边距，为页眉留出更多空间
              right: 800,    // 减小右边距，适应小屏幕
              bottom: 600,
              left: 800,     // 减小左边距，适应小屏幕
            },
          },
        },
        headers: {
          default: new Header({
            children: [
              ...
              new Paragraph({
                ...
                alignment: AlignmentType.LEFT,
                spacing: { after: 80 }  // 减小间距
              }),
              // 地址信息使用更紧凑的布局
              new Paragraph({
                alignment: AlignmentType.RIGHT,
                spacing: { before: 0, after: 0, line: 240 },  // 添加行距控制
                children: [
                  new TextRun({
                    text: '1300 Aztec West, Park Avenue,',  // 合并地址行
                    size: 14,                               // 减小字号
                    font: 'Calibri'
                  })
                ]
              ...
              new Paragraph({
                ...
                children: [
                  new TextRun({
                    text: 'Aztec West, Bristol, BS32 4RX',  // 合并地址行
                    size: 14,
                    font: 'Calibri'
                  })
                ]
              ...
              new Paragraph({
                ...
                children: [
                  new TextRun({
                    text: 't +44 (0) 01454 207360  f +44 (0) 01454 207367',  // 合并电话和传真
                    size: 14,
                    font: 'Calibri'
                  })
                ]
              ...
              new Paragraph({
                children: [
                  new TextRun({
                    text: '_'.repeat(90),  // 使用更少的下划线字符
                    size: 16,              // 减小下划线字号
                    color: "666666"        // 使用更浅的颜色
                  })
                ],
                spacing: { before: 40, after: 40 }
              })
