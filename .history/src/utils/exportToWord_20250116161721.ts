      ...
      sections: [{
        ...
        children: [
          ...
          createTable([
            ...
            createTableRow('DIMENSIONS - WIDTH', '380MM'),
            createTableRow('DIMENSIONS - DEPTH', '640MM'),
            createTableRow('DIMENSIONS - HEIGHT', '600MM'),
            createTableRow('BOARD TYPE', '250lbs, 5 layers twin walled'),
            createTableRow('Items per carton', '1pc'),
            createTableRow('CARTON VOLUME (m³)', '0.146'),
