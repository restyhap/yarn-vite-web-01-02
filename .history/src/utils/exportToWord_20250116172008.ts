      ...
      sections: [{
        ...
        children: [
          ...
          createTable([
            ...
            createProductDimensionsTableRow('WIDTH', '', 'SEAT', true),
            createProductDimensionsTableRow('DEPTH', '490MM'),
            createProductDimensionsTableRow('WIDTH', '460MM', 'BACK', false, { isSecondColumnStart: true, rowSpan: 2, secondColumnText: 'BACK' }),
            createProductDimensionsTableRow('HEIGHT', '485-550MM'),
            ...
            createProductDimensionsTableRow('FROM SEAT', '485-550MM', 'SEAT HEIGHT', false, { isSecondColumnStart: true, rowSpan: 1, secondColumnText: 'SEAT HEIGHT' }),
            ...
            createProductDimensionsTableRow('HEIGHT', '555-900MM'),
          ], 100),
        ],
      }],
    })
