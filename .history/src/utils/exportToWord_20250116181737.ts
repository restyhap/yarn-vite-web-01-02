    ...
    const doc = new Document({
      sections: [{
        ...
        children: [
          ...
          // SEAT INNER 表格
          createTable([
            createTableRow('SEAT INNER - Material Code', formData.seat_inner?.material_code || 'N/A'),
            createTableRow('Thickness', formData.seat_inner?.thickness || 'N/A'),
            createTableRow('Layers Count', formData.seat_inner?.layers_count || 'N/A'),
            createTableRow('Dimensions', formData.seat_inner?.dimensions || 'N/A')
          ], 80),

          // BACK INNER 表格
          createTable([
            createTableRow('BACK INNER - Material Code', formData.back_inner?.material_code || 'N/A'),
            createTableRow('Thickness', formData.back_inner?.thickness || 'N/A'),
            createTableRow('Layers Count', formData.back_inner?.layers_count || 'N/A'),
            createTableRow('Dimensions', formData.back_inner?.dimensions || 'N/A')
          ], 80),

          // BACK OUTER 表格
          createTable([
            createTableRow('BACK OUTER - Material', formData.back_outer?.material || 'N/A'),
            createTableRow('Dimensions', formData.back_outer?.dimensions || 'N/A'),
            createTableRow('Manufacturer Name', formData.back_outer?.manufacturer_name || 'N/A')
          ], 80),

          // SEAT OUTER 表格
          createTable([
            createTableRow('SEAT OUTER - Material', formData.seat_outer?.material || 'N/A'),
            createTableRow('Dimensions', formData.seat_outer?.dimensions || 'N/A'),
            createTableRow('Manufacturer Name', formData.seat_outer?.manufacturer_name || 'N/A')
          ], 80),

          // ARMS 表格
          createTable([
            createTableRow('ARMS - Material', formData.arms?.material || 'N/A'),
            createTableRow('Type', formData.arms?.type || 'N/A'),
            createTableRow('Manufacturer', formData.arms?.manufacturer || 'N/A'),
            createTableRow('Description', formData.arms?.description || 'N/A'),
            createTableRow('Arm Height from Seat', formData.arms?.arm_height_from_seat || 'N/A'),
            createTableRow('Arm Height from Floor', formData.arms?.arm_height_from_floor || 'N/A')
          ], 80),

          // FOAM 表格
          createTable([
            createTableRow('FOAM - Description', formData.foam?.description || 'N/A'),
            createTableRow('Seat Density', formData.foam?.seat_density || 'N/A'),
            createTableRow('Back Density', formData.foam?.back_density || 'N/A'),
            createTableRow('Seat Thickness', formData.foam?.seat_thickness || 'N/A'),
            createTableRow('Back Thickness', formData.foam?.back_thickness || 'N/A')
          ], 80),

          // CASTORS 表格
          createTable([
            createTableRow('CASTORS - Description', formData.castors?.description || 'N/A'),
            createTableRow('Pin Thickness', formData.castors?.pin_thickness || 'N/A'),
            createTableRow('Wheel Diameter', formData.castors?.wheel_diameter || 'N/A')
          ], 80),

          // BASE 表格
          createTable([
            createTableRow('BASE - Description', formData.base?.description || 'N/A'),
            createTableRow('Size Diameter', formData.base?.size_diameter || 'N/A'),
            createTableRow('Material', formData.base?.material || 'N/A'),
            createTableRow('Type', formData.base?.type || 'N/A')
          ], 80),

          // GAS LIFT 表格
          createTable([
            createTableRow('GAS LIFT - Description', formData.gas_lift?.description || 'N/A'),
            createTableRow('Gas Lift Class', formData.gas_lift?.gas_lift_class || 'N/A'),
            createTableRow('Casing Length', formData.gas_lift?.casing_length || 'N/A'),
            createTableRow('Extension Size', formData.gas_lift?.extension_size || 'N/A'),
            createTableRow('Taper', formData.gas_lift?.taper || 'N/A')
          ], 80),

          // GAS LIFT COVER 表格
          createTable([
            createTableRow('GAS LIFT COVER - Description', formData.gas_lift_cover?.description || 'N/A'),
            createTableRow('Material', formData.gas_lift_cover?.material || 'N/A'),
            createTableRow('Colour', formData.gas_lift_cover?.colour || 'N/A')
          ], 80),

          // MECHANISM 表格
          createTable([
            createTableRow('MECHANISM - Description', formData.mechanism?.description || 'N/A'),
            createTableRow('Levers Count', formData.mechanism?.levers_count || 'N/A'),
            createTableRow('Locking Positions', formData.mechanism?.locking_positions || 'N/A'),
            createTableRow('Model No', formData.mechanism?.model_no || 'N/A'),
            createTableRow('Supplier Name', formData.mechanism?.supplier_name || 'N/A')
          ], 80),

          // FITTINGS 表格
          createTable([
            createTableRow('FITTINGS - Fitting Number', formData.fittings?.fitting_number || 'N/A'),
            createTableRow('Description', formData.fittings?.description || 'N/A'),
            createTableRow('Quantity', formData.fittings?.quantity || 'N/A'),
            createTableRow('Material', formData.fittings?.material || 'N/A')
          ], 80),
        ],
      }],
      styles: {
