import { Document, Packer, Paragraph, Table, TableCell, TableRow, TextRun, AlignmentType, HeadingLevel, BorderStyle, VerticalAlign, WidthType, ImageRun, Media } from 'docx'
...
export const exportToWord = async (formData: FormData) => {
  try {
    // 获取所有图片的 base64 数据
    const frontImageBase64 = formData.images?.front_img_path ? await getImageBase64(formData.images.front_img_path) : null
    const sideImageBase64 = formData.images?.side_img_path ? await getImageBase64(formData.images.side_img_path) : null
    const backImageBase64 = formData.images?.back_view_path ? await getImageBase64(formData.images.back_view_path) : null
    const angleImageBase64 = formData.images?.angle_view_path ? await getImageBase64(formData.images.angle_view_path) : null
                ...
                children: [
                  new TableCell({
                    ...
                    children: [
                      ...
                      frontImageBase64 ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                ...
                children: [
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      angleImageBase64 ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
