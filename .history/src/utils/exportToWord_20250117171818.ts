      ...
      sections: [{
        ...
        children: [
          ...
          createTable([
            ...
            createThreeColumnTableRow('', 'COLOUR CODE', formData.upholstery?.colour_code || 'N/A'),
            createThreeColumnTableRow('', 'LEATHER GRADE (WHERE APPLICABLE)', formData.upholstery?.leather_grade || 'N/A'),
            createThreeColumnTableRow('', 'USAGE PER CHAIR（BACK/SEAT)', formData.upholstery?.usage_per_chair || 'N/A')
          ], 90),
