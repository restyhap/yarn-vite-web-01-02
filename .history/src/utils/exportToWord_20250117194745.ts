 ...
 * 获取图片数据并创建 Media 对象
 * @param url - 图片URL
 * @returns Promise<Media> - 返回 Media 对象
 */
const createImageMedia = async (url: string): Promise<Media> => {
  const response = await fetch(url)
  const arrayBuffer = await response.arrayBuffer()
  return Media.addImage(doc, Buffer.from(arrayBuffer))
}
                ...
                children: [
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.front_img_path ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                            data: await createImageMedia(formData.images.front_img_path),
                            transformation: {
                              width: 200,
                              height: 200
                            }
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.side_img_path ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                            data: await createImageMedia(formData.images.side_img_path),
                            transformation: {
                              width: 200,
                              height: 200
                            }
                ...
                children: [
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.back_view_path ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                            data: await createImageMedia(formData.images.back_view_path),
                            transformation: {
                              width: 200,
                              height: 200
                            }
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.angle_view_path ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                            data: await createImageMedia(formData.images.angle_view_path),
                            transformation: {
                              width: 200,
                              height: 200
                            }
