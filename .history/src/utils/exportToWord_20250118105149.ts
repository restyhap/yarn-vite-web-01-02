import { Document, Packer, Paragraph, Table, TableCell, TableRow, TextRun, AlignmentType, HeadingLevel, BorderStyle, VerticalAlign, WidthType, ImageRun, Media, Header, HeightRule } from 'docx'
...
const getLogoBuffer = async (): Promise<Uint8Array> => {
  try {
    const response = await fetch('/tc-logo.png')
    if (!response.ok) {
    ...
    const doc = new Document({
      sections: [{
                      ...
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            ...
                            spacing: { line: 180, lineRule: 'atLeast', before: 100 },  // 添加上方间距
                            children: [
                              new TextRun({
        ...
        children: [
          ...
          new Paragraph({
            alignment: AlignmentType.CENTER,
            spacing: { before: 60, after: 60 },  // 减小单位说明的间距
            children: [
              new TextRun({
                ...
                children: [
                  new TableCell({
                    ...
                    children: [
                      ...
                      frontImageBuffer ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                ...
                children: [
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      angleImageBuffer ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
