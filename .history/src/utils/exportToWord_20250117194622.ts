                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.front_img_path ? new Paragraph({
                        ...
                        children: [
                          new ImageRun({
                            data: Buffer.from(formData.images.front_img_path.split(',')[1], 'base64'),
                            transformation: {
                              width: 200,
                              height: 200
                            }
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.side_img_path ? new Paragraph({
                        ...
                        children: [
                          new ImageRun({
                            data: Buffer.from(formData.images.side_img_path.split(',')[1], 'base64'),
                            transformation: {
                              width: 200,
                              height: 200
                            }
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.back_view_path ? new Paragraph({
                        ...
                        children: [
                          new ImageRun({
                            data: Buffer.from(formData.images.back_view_path.split(',')[1], 'base64'),
                            transformation: {
                              width: 200,
                              height: 200
                            }
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.angle_view_path ? new Paragraph({
                        ...
                        children: [
                          new ImageRun({
                            data: Buffer.from(formData.images.angle_view_path.split(',')[1], 'base64'),
                            transformation: {
                              width: 200,
                              height: 200
                            }
