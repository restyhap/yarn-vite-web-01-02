      ...
      sections: [{
        ...
        children: [
          ...
          createTable([
            ...
            // CARTON 部分
            createCartonTableRow('WIDTH', (formData.carton_width ? formData.carton_width + 'MM' : 'N/A'), true),
            createCartonTableRow('DEPTH', (formData.carton_depth ? formData.carton_depth + 'MM' : 'N/A')),
            createCartonTableRow('HEIGHT', (formData.carton_height ? formData.carton_height + 'MM' : 'N/A')),
            createCartonTableRow('BOARD TYPE', formData.board_type || 'N/A'),
            createCartonTableRow('Items per carton', (formData.items_per_carton ? formData.items_per_carton + 'pc' : 'N/A')),
            createCartonTableRow('CARTON VOLUME (m³)', formData.carton_volume || 'N/A'),

            // PRODUCT 部分
            createProductTableRow('PRODUCTION TIME (DAYS)', (formData.production_time ? formData.production_time + 'Day' : 'N/A'), undefined, true),
            createProductTableRow('EFFECTIVE VOLUME (m³)', formData.effective_volume || 'N/A'),
            createProductTableRow('LOADING QUANTITY', formData.loading_quantity_20gp || 'N/A', '20\'GP', false, true),
            createProductTableRow('', formData.loading_quantity_40hc || 'N/A', '40\'HC'),
            createProductTableRow('WEIGHT (KG)', (formData.weight_net ? formData.weight_net + 'KG' : 'N/A'), 'NET', false, true),
            createProductTableRow('', (formData.weight_gross ? formData.weight_gross + 'KG' : 'N/A'), 'GROSS'),

            // PRODUCT DIMENSIONS 部分
            createProductDimensionsTableRow('WIDTH', (formData.seat_width ? formData.seat_width + 'MM' : 'N/A'), 'SEAT', true),
            createProductDimensionsTableRow('DEPTH', (formData.seat_depth ? formData.seat_depth + 'MM' : 'N/A')),
            createProductDimensionsTableRow('WIDTH', (formData.back_width ? formData.back_width + 'MM' : 'N/A'), 'BACK', false, { isSecondColumnStart: true, rowSpan: 2, secondColumnText: 'BACK' }),
            createProductDimensionsTableRow('HEIGHT', (formData.back_height ? formData.back_height + 'MM' : 'N/A')),
            createProductDimensionsTableRow('MIN', (formData.seat_height_min ? formData.seat_height_min + 'MM' : 'N/A'), 'SEAT HEIGHT', false, { isSecondColumnStart: true, rowSpan: 2, secondColumnText: 'SEAT HEIGHT' }),
            createProductDimensionsTableRow('MAX', (formData.seat_height_max ? formData.seat_height_max + 'MM' : 'N/A')),
            createProductDimensionsTableRow('FROM SEAT', (formData.seat_height_from_seat ? formData.seat_height_from_seat + 'MM' : 'N/A'), 'SEAT HEIGHT', false, { isSecondColumnStart: true, rowSpan: 1, secondColumnText: 'SEAT HEIGHT' }),
            createProductDimensionsTableRow('WIDTH', (formData.overall_width ? formData.overall_width + 'MM' : 'N/A'), 'OVERALL', false, { isSecondColumnStart: true, rowSpan: 3, secondColumnText: 'OVERALL' }),
            createProductDimensionsTableRow('DEPTH', (formData.overall_depth ? formData.overall_depth + 'MM' : 'N/A')),
            createProductDimensionsTableRow('HEIGHT', (formData.overall_height ? formData.overall_height + 'MM' : 'N/A')),
          ], 100),
        ],
      }],
    })
