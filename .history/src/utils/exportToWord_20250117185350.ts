...
const createImageTableRow = async (title: string, imageUrl: string | undefined, isFirstRow = false) => {
  // 如果没有图片URL,返回一个空的单元格
  if (!imageUrl) {
    return createEmptyImageCell('No Image Available')
  }
  ...
  try {
    ...
    return createEmptyImageCell(`Failed to load ${title}`)
  }
}
 ...
 * 创建空的图片单元格
 */
const createEmptyImageCell = (message: string) => {
  return new TableRow({
    children: [
      new TableCell({
        width: {
 ...
 * 获取图片buffer
 */
const getImageBuffer = async (imageUrl: string | undefined): Promise<Buffer> => {
  if (!imageUrl) {
    // 返回一个空白图片或占位符图片的buffer
    return Buffer.from('')
  }
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      new Paragraph({
                        ...
                        children: [
                          new ImageRun({
                            data: await getImageBuffer(formData.images?.front_img_path),
                            transformation: {
                              width: 300,
                              height: 225
                            },
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      new Paragraph({
                        ...
                        children: [
                          new ImageRun({
                            data: await getImageBuffer(formData.images?.side_img_path),
                            transformation: {
                              width: 300,
                              height: 225
                            },
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      new Paragraph({
                        ...
                        children: [
                          new ImageRun({
                            data: await getImageBuffer(formData.images?.back_view_path),
                            transformation: {
                              width: 300,
                              height: 225
                            },
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      new Paragraph({
                        ...
                        children: [
                          new ImageRun({
                            data: await getImageBuffer(formData.images?.angle_view_path),
                            transformation: {
                              width: 300,
                              height: 225
                            },
