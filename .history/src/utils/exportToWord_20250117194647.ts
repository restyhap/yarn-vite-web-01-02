...
export const exportToWord = async (formData: FormData) => {
  try {
    // 获取所有图片数据
    const frontImageData = formData.images?.front_img_path ? await getImageData(formData.images.front_img_path) : null
    const sideImageData = formData.images?.side_img_path ? await getImageData(formData.images.side_img_path) : null
    const backImageData = formData.images?.back_view_path ? await getImageData(formData.images.back_view_path) : null
    const angleImageData = formData.images?.angle_view_path ? await getImageData(formData.images.angle_view_path) : null
                ...
                children: [
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.front_img_path && frontImageData ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                            data: frontImageData,
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.side_img_path && sideImageData ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                            data: sideImageData,
                ...
                children: [
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.back_view_path && backImageData ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                            data: backImageData,
                  ...
                  new TableCell({
                    ...
                    children: [
                      ...
                      formData.images?.angle_view_path && angleImageData ? new Paragraph({
                        alignment: AlignmentType.CENTER,
                        children: [
                          new ImageRun({
                            data: angleImageData,
