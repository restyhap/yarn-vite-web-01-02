    ...
    const doc = new Document({
      sections: [{
        ...
        children: [
          ...
          createTable([
            // UPHOLSTERY 部分
            createThreeColumnTableRow('UPHOLSTERY', 'FABRIC MANUFACTURER', formData.upholstery?.fabric_manufacturer || 'N/A', true, 4),
            createThreeColumnTableRow('', 'COLOUR CODE', formData.upholstery?.colour_code || 'N/A', false),
            createThreeColumnTableRow('', 'LEATHER GRADE (WHERE APPLICABLE)', formData.upholstery?.leather_grade || 'N/A', false),
            createThreeColumnTableRow('', 'USAGE PER CHAIR (BACK/SEAT)', formData.upholstery?.usage_per_chair || 'N/A', false),
