<template>
  <div class="flex h-full items-center justify-center">  <!-- 添加居中对齐 -->
    <div class="w-full max-w-7xl p-6">  <!-- 添加最大宽度和padding -->
          ...
          <div v-for="role in roles" :key="role.id" class="border rounded-lg p-6">
            ...
            <div class="space-y-4">
              <div v-for="module in permissionModules" :key="module.id" class="border-t pt-4">
                ...
                <div class="ml-6 flex flex-wrap items-center justify-center gap-2">
