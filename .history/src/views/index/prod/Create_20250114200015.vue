      ...
      <div class="form-container">
        ...
        >
          ...
          <el-form-item label="厚度">
            <el-input-number v-model="innerComponentsForm.thickness" class="w-full" />
          </el-form-item>
          <el-form-item label="层数">
            <el-input-number v-model="innerComponentsForm.layers_count" class="w-full" />
          </el-form-item>
        ...
        <div class="steps-control">
          ...
          <el-button type="primary" @click="nextStep" v-if="activeStep < 14">下一步</el-button>
