 ...
 * @LastEditTime: 2025-01-16 11:10:11
...
/* 编辑状态的样式 */
.table-section:has(.el-form-item:has(.el-input)) {
  background-color: #fafcff;
  border: 1px solid #409eff;
}

.table-section:has(.el-form-item:has(.el-input)) .section-header {
  border-bottom-color: #409eff;
}

.table-section:has(.el-form-item:has(.el-input)) :deep(.el-form-item__label) {
...
.table-section:has(.el-form-item:has(.el-input)) :deep(.el-form-item__content) {
  border-color: #a3d0ff;
  background-color: #fff;
}
