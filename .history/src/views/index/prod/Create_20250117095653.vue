 ...
 * @LastEditTime: 2025-01-17 09:56:53
          ...
          <el-form-item label="正视图">
            <div class="upload-preview-container">
              <el-upload
                ...
                :on-success="(res, file) => handleSuccess(res, file, 'front_img_path')"
          ...
          <el-form-item label="侧视图">
            <div class="upload-preview-container">
              <el-upload
                ...
                :show-file-list="false"
                :before-upload="beforeUpload"
                :on-success="(res, file) => handleSuccess(res, file, 'side_img_path')"
                :on-error="handleError"
              >
          ...
          <el-form-item label="背视图">
            <div class="upload-preview-container">
              <el-upload
                ...
                :show-file-list="false"
                :before-upload="beforeUpload"
                :on-success="(res, file) => handleSuccess(res, file, 'back_view_path')"
                :on-error="handleError"
              >
          ...
          <el-form-item label="角视图">
            <div class="upload-preview-container">
              <el-upload
                ...
                :show-file-list="false"
                :before-upload="beforeUpload"
                :on-success="(res, file) => handleSuccess(res, file, 'angle_view_path')"
                :on-error="handleError"
              >
                <template v-if="productImagesForm.angle_view_path">
                  <div class="image-preview">
                    <img :src="productImagesForm.angle_view_path" alt="角视图" />
                    <div class="image-actions">
                      <el-button type="danger" @click.stop="handleRemove('angle_view_path')">删除</el-button>
                    </div>
                  </div>
                </template>
                <template v-else>
...
// 处理图片上传成功
const handleSuccess: UploadProps['onSuccess'] = (response, uploadFile, type: string) => {
...
// 产品图片上传组件
const ProductImagesForm = defineComponent({
  name: 'ProductImagesForm',
  template: `
    <div class="form-container">
      <div class="upload-section">
        <h3 class="section-title">产品图片上传</h3>
        <p class="section-description">请上传清晰的产品图片，图片大小不超过2MB</p>
        ...
        <div class="upload-grid">
          ...
          <div class="upload-item">
            ...
            >
              <template v-if="formData.front_view">
                <div class="image-preview">
                  <img :src="formData.front_view" alt="正视图" />
                  <div class="image-actions">
                    <el-button type="danger" @click="handleRemove('front_view')">删除</el-button>
                  </div>
                </div>
              </template>
              <template v-else>
          ...
          <div class="upload-item">
            ...
            <el-upload
              ...
              :on-remove="handleRemove"
            >
              <template v-if="formData.side_view">
                <div class="image-preview">
                  <img :src="formData.side_view" alt="侧视图" />
                  <div class="image-actions">
                    <el-button type="danger" @click="handleRemove('side_view')">删除</el-button>
                  </div>
                </div>
              </template>
              <template v-else>
          ...
          <div class="upload-item">
            ...
            <el-upload
              ...
              :on-remove="handleRemove"
            >
              <template v-if="formData.back_view">
                <div class="image-preview">
                  <img :src="formData.back_view" alt="背视图" />
                  <div class="image-actions">
                    <el-button type="danger" @click="handleRemove('back_view')">删除</el-button>
                  </div>
                </div>
              </template>
              <template v-else>
          ...
          <!-- 45度角视图上传 -->
          <div class="upload-item">
            <div class="upload-label">45度角视图</div>
            <el-upload
              class="upload-component"
              action="#"
              :show-file-list="false"
              ...
              :on-remove="handleRemove"
            >
              <template v-if="formData.angle_45_view">
                <div class="image-preview">
                  <img :src="formData.angle_45_view" alt="45度角视图" />
                  <div class="image-actions">
                    <el-button type="danger" @click="handleRemove('angle_45_view')">删除</el-button>
                  </div>
                </div>
              </template>
              <template v-else>
  ...
  setup() {
    type ImageFormData = {
      ...
      side_view: string;
      back_view: string;
      angle_45_view: string;
    }

    type ImageType = keyof ImageFormData;
    ...
    // 处理图片上传成功
    const handleSuccess = (response: any, file: any, type: ImageType) => {
      formData.value[type] = URL.createObjectURL(file.raw)
      ElMessage.success('上传成功')
    }
