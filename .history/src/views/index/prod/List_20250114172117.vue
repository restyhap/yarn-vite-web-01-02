  ...
  <div class="flex-1 p-8">
    <div class="bg-white rounded-lg shadow p-6">
      ...
      >
        ...
        <el-table-column prop="supplier_name" label="供应商名称" width="160" />
        <el-table-column prop="fire_standard" label="防火标准" width="120" />
        <el-table-column prop="fob_20_container_price" label="20尺柜FOB价格" width="130">
          <template #default="scope">
            ¥{{ scope.row.fob_20_container_price?.toLocaleString('zh-CN', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}
          </template>
        </el-table-column>
        <el-table-column prop="fob_40_container_price" label="40尺柜FOB价格" width="130">
          <template #default="scope">
        ...
        <el-table-column label="操作" width="160" fixed="right">
          <template #default="scope">
            <div class="flex items-center space-x-1">
              <el-button type="primary" link size="small" class="text-xs" @click="handleView(scope.row)">
                <el-icon><View /></el-icon>
                查看
              </el-button>
              <el-button type="primary" link size="small" class="text-xs" @click="handleEdit(scope.row)">
                <el-icon><Edit /></el-icon>
                编辑
              </el-button>
              <el-button type="danger" link size="small" class="text-xs" @click="handleDelete(scope.row)">
