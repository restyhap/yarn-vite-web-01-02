 ...
 * @LastEditTime: 2025-01-16 08:21:06
...
// 格式化规格表字段
const formatSpecValue = (section: string, field: string) => {
  const value = specTables.value[section]?.[field as keyof SpecTableFields]
  if (!value) return '-'
