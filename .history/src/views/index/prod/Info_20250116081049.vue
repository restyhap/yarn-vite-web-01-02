 ...
 * @LastEditTime: 2025-01-16 08:10:48
                  ...
                  <table class="w-full border-collapse">
                    <tbody>
                      <tr class="border border-gray-300">
                        ...
                        <td class="border border-gray-300 p-2 w-1/2">{{ productInfo.value.tccode }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">SUPPLIER</td>
                        <td class="border border-gray-300 p-2">{{ productInfo.value.supplier }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">SUPPLIER CODE</td>
                        <td class="border border-gray-300 p-2">{{ productInfo.value.supplier_code }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">SUPPLIER NAME</td>
                        <td class="border border-gray-300 p-2">{{ productInfo.value.supplier_name }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">FIRE STANDARD</td>
                        <td class="border border-gray-300 p-2">{{ productInfo.value.fire_standard }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">FOB 20' CONTAINER PRICE</td>
                        <td class="border border-gray-300 p-2">{{ productInfo.value.fob_20_container_price }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">FOB 40'HC CONTAINER PRICE</td>
                        <td class="border border-gray-300 p-2">{{ productInfo.value.fob_40_container_price }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">SHIPPING PORT</td>
                        <td class="border border-gray-300 p-2">{{ productInfo.value.shipping_port }}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      <el-descriptions-item label="面料制造商">{{
                          specTables.value.upholstery?.fabric_manufacturer
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="颜色代码">{{
                          specTables.value.upholstery?.colour_code
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="皮革等级">{{
                          specTables.value.upholstery?.leather_grade
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="每把椅子用料">{{
                          specTables.value.upholstery?.usage_per_chair
                        }}m²
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
...
interface SpecTables {
  ...
  [key: string]: SpecTableItem | { [key: string]: string | undefined }
}
