...
const fetchData = async () => {
  ...
  try {
    ...
    formData.value = {
      ...
      images: {
        front_img_path: 'https://example.com/images/front.jpg',
        side_img_path: 'https://example.com/images/side.jpg',
        back_view_path: 'https://example.com/images/back.jpg',
        angle_view_path: 'https://example.com/images/angle.jpg'
      }
    }
