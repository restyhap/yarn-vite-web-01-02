          ...
          <el-upload
              ...
              >
                {formData.value.fileList[0] ? (
                  <div class="image-preview">
                    <img src={formData.value.fileList[0].url} alt="正视图" />
                    <div class="image-actions">
                      <el-button type="danger" onClick={() => handleRemove(formData.value.fileList[0])}>删除</el-button>
              </div>
                  </div>
                ) : (
            ...
            <div class="upload-item">
              ...
              <el-upload
                ...
                :on-remove="handleRemove"
              >
                {formData.value.fileList[1] ? (
                  <div class="image-preview">
                    <img src={formData.value.fileList[1].url} alt="侧视图" />
                    <div class="image-actions">
                      <el-button type="danger" onClick={() => handleRemove(formData.value.fileList[1])}>删除</el-button>
                    </div>
                  </div>
                ) : (
                  <div class="upload-placeholder">
            ...
            <div class="upload-item">
              ...
              <el-upload
                ...
                :on-remove="handleRemove"
              >
                {formData.value.fileList[2] ? (
                  <div class="image-preview">
                    <img src={formData.value.fileList[2].url} alt="背视图" />
                    <div class="image-actions">
                      <el-button type="danger" onClick={() => handleRemove(formData.value.fileList[2])}>删除</el-button>
                    </div>
                  </div>
                ) : (
                  <div class="upload-placeholder">
            ...
            <div class="upload-item">
              ...
              <el-upload
                ...
                :on-remove="handleRemove"
              >
                {formData.value.fileList[3] ? (
                  <div class="image-preview">
                    <img src={formData.value.fileList[3].url} alt="45度角视图" />
                    <div class="image-actions">
                      <el-button type="danger" onClick={() => handleRemove(formData.value.fileList[3])}>删除</el-button>
                    </div>
                  </div>
                ) : (
                  <div class="upload-placeholder">
