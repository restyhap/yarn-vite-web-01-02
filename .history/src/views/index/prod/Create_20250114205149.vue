 ...
 * @LastEditTime: 2025-01-14 20:43:08
        ...
        <div class="steps-control-wrapper">
          <div class="steps-control">
            <div class="button-group">
              ...
              <el-button type="primary" @click="nextStep" v-if="activeStep < 16">下一步</el-button>
...
:deep(.el-steps)::-webkit-scrollbar {
  height: 6px;
}

:deep(.el-steps)::-webkit-scrollbar-thumb {
  background: #dcdfe6;
  border-radius: 3px;
}

:deep(.el-steps)::-webkit-scrollbar-track {
  background: #f5f7fa;
}
</style> 