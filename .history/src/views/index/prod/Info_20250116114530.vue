 ...
 * @LastEditTime: 2025-01-16 11:45:30
      ...
      <html>
        <head>
          <style>
            ...
            .note { font-size: 10pt; font-style: italic; margin: 10px 0; }
          </style>
        </head>
        <body>
          ...
          <table>
            ...
            <tr>
              <td>FOB 20' CONTAINER PRICE</td>
              <td>${formData.value.fob_20_container_price || ''}</td>
            </tr>
            <tr>
              <td>FOB 40'HC CONTAINER PRICE</td>
          ...
          <table>
            <tr>
              <td style="width: 30%">FABRIC MANUFACTURER</td>
            ...
            <tr>
              <td>LEATHER GRADE (WHERE APPLICABLE)</td>
              <td>${formData.value.upholstery?.leather_grade || ''}</td>
            </tr>
            <tr>
              <td>USAGE PER CHAIR（BACK/SEAT）</td>
          ...
          <table>
            <tr>
              <td rowspan="3" style="width: 30%">DIMENSIONS</td>
          ...
          <table>
            <tr>
              <td style="width: 30%">PRODUCTION TIME (DAYS)</td>
              <td>${formData.value.logistics?.production_time || ''}</td>
            </tr>
            <tr>
              <td>EFFECTIVE VOLUME (m³)</td>
              <td>${formData.value.logistics?.effective_volume || ''}</td>
            </tr>
            <tr>
              <td rowspan="2">LOADING QUANTITY</td>
          ...
          <table>
            <tr>
              <td rowspan="2" style="width: 30%">SEAT</td>
              <td style="width: 20%">WIDTH</td>
...
const generateOtherTables = () => {
  ...
  tables.push(`
    ...
    <table>
      <tr>
        <td style="width: 30%">Material Code</td>
  ...
  tables.push(`
    ...
    <table>
      <tr>
        <td style="width: 30%">Fitting Number</td>
