 ...
 * @LastEditTime: 2025-01-17 11:08:58
  ...
  <div class="create-product">
    <el-card class="form-card">
      <el-steps :active="activeStep" finish-status="success" class="steps-container">
        <el-step title="基本信息" @click="goToStep(0)" />
        <el-step title="面料信息" @click="goToStep(1)" />
        <el-step title="包装信息" @click="goToStep(2)" />
        <el-step title="生产物流" @click="goToStep(3)" />
        <el-step title="产品尺寸" @click="goToStep(4)" />
        <el-step title="座椅内部结构" @click="goToStep(5)" />
        <el-step title="背部内部结构" @click="goToStep(6)" />
        <el-step title="座椅外部结构" @click="goToStep(7)" />
        <el-step title="背部外部结构" @click="goToStep(8)" />
        <el-step title="扶手信息" @click="goToStep(9)" />
        <el-step title="泡棉信息" @click="goToStep(10)" />
        <el-step title="脚轮信息" @click="goToStep(11)" />
        <el-step title="底座信息" @click="goToStep(12)" />
        <el-step title="气压棒" @click="goToStep(13)" />
        <el-step title="气压罩" @click="goToStep(14)" />
        <el-step title="机构信息" @click="goToStep(15)" />
        <el-step title="配件信息" @click="goToStep(16)" />
        <el-step title="产品图片" @click="goToStep(17)" />
      </el-steps>
            ...
            <el-form-item label="角视图">
              <div class="upload-preview-container">
                <el-upload
                  ...
                  :show-file-list="false"
                  :before-upload="beforeUpload"
                  :on-success="createHandleSuccess('angle_view_path')"
                  :on-error="handleError"
                >
