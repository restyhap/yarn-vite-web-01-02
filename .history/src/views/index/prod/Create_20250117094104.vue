 ...
 * @LastEditTime: 2025-01-17 09:40:19
...
import { ref, reactive, onMounted, onUnmounted, onBeforeUnmount, defineComponent } from 'vue'
...
const ProductImagesForm = defineComponent({
  setup() {
    ...
    return () => (
      <el-form label-width="140px" class="form-content">
        <el-form-item label="产品图片">
          <el-upload
            v-model:file-list={formData.value.fileList}
            action="#"
          ...
          >
            ...
            <template #tip>
              <div class="el-upload__tip">
                请上传产品的正视图、侧视图、背视图和45度角视图，图片不超过2MB
              </div>
            </template>
          </el-upload>
        </el-form-item>
