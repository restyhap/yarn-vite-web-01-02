 ...
 * @LastEditTime: 2025-01-17 10:33:28
          ...
          <el-form-item label="正视图">
            <div class="upload-preview-container">
              <el-upload
                ...
                :on-success="(res: any, file: UploadFile) => handleSuccess(res, file, 'front_img_path')"
          ...
          <el-form-item label="侧视图">
            <div class="upload-preview-container">
              <el-upload
                ...
                :show-file-list="false"
                :before-upload="beforeUpload"
                :on-success="(res: any, file: UploadFile) => handleSuccess(res, file, 'side_img_path')"
                :on-error="handleError"
              >
          ...
          <el-form-item label="背视图">
            <div class="upload-preview-container">
              <el-upload
                ...
                :show-file-list="false"
                :before-upload="beforeUpload"
                :on-success="(res: any, file: UploadFile) => handleSuccess(res, file, 'back_view_path')"
                :on-error="handleError"
              >
          ...
          <el-form-item label="角视图">
            <div class="upload-preview-container">
              <el-upload
                ...
                :show-file-list="false"
                :before-upload="beforeUpload"
                :on-success="(res: any, file: UploadFile) => handleSuccess(res, file, 'angle_view_path')"
                :on-error="handleError"
              >
