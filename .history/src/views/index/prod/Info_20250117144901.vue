                    ...
                    <template v-else>
                      <template v-if="isImageField(key)">
                        <div class="image-container">
                          <div class="image-preview" v-if="formData[sectionKey]?.[key]">
...
const fetchData = async () => {
  ...
  try {
    ...
    formData.value = {
      ...
      images: {
        front_img_path: 'https://img.alicdn.com/imgextra/i4/2966343102/O1CN01RRmZxA1YoIK5lRLRT_!!2966343102.jpg',
        side_img_path: 'https://img.alicdn.com/imgextra/i1/2966343102/O1CN01jnWXpE1YoIK4fqnQa_!!2966343102.jpg',
        back_view_path: 'https://img.alicdn.com/imgextra/i2/2966343102/O1CN01Cjdf001YoIK2aJY1Z_!!2966343102.jpg',
        angle_view_path: 'https://img.alicdn.com/imgextra/i3/2966343102/O1CN01tQv7yX1YoIK5lRn5r_!!2966343102.jpg'
      }
    }
