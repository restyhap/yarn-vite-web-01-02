 ...
 * @LastEditTime: 2025-01-16 13:40:32
...
import { Document as DocxDocument, Packer, Paragraph, Table, TableCell, TableRow, TextRun, AlignmentType, HeadingLevel, BorderStyle } from 'docx'
            ...
            rows: [
              new TableRow({
                children: [
                  ...
                  new TableCell({
                    children: [new Paragraph(formData.value.tccode || '')]
                  }),
                ],
              }),
              // ... 其他基本信息行
