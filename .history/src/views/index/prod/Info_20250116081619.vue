 ...
 * @LastEditTime: 2025-01-16 08:16:17
        ...
        <el-skeleton :loading="loading" animated>
          <template #template>
            <div class="bg-white rounded-lg shadow p-6">
              ...
              <el-skeleton-item variant="text" style="width: 100%; height: 300px; margin-top: 16px" />
            </div>
          </template>
            ...
            <div class="bg-white rounded-lg shadow">
              ...
              <div class="p-6">
                ...
                <div class="text-center mb-6">
                  <h1 class="text-red-600 text-2xl font-bold">FULL PRODUCT SPECIFICATION SHEET ( 包装信息表 )</h1>
                </div>
                  ...
                  <table class="w-full border-collapse">
                    <tbody>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2 w-1/2">TCCODE</td>
                        <td class="border border-gray-300 p-2 w-1/2">{{ (productInfo as Ref<ProductInfo>).value?.tccode || '-' }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">SUPPLIER</td>
                        <td class="border border-gray-300 p-2">{{ (productInfo as Ref<ProductInfo>).value?.supplier || '-' }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">SUPPLIER CODE</td>
                        <td class="border border-gray-300 p-2">{{ (productInfo as Ref<ProductInfo>).value?.supplier_code || '-' }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">SUPPLIER NAME</td>
                        <td class="border border-gray-300 p-2">{{ (productInfo as Ref<ProductInfo>).value?.supplier_name || '-' }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">FIRE STANDARD</td>
                        <td class="border border-gray-300 p-2">{{ (productInfo as Ref<ProductInfo>).value?.fire_standard || '-' }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">FOB 20' CONTAINER PRICE</td>
                        <td class="border border-gray-300 p-2">{{ (productInfo as Ref<ProductInfo>).value?.fob_20_container_price || '-' }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">FOB 40'HC CONTAINER PRICE</td>
                        <td class="border border-gray-300 p-2">{{ (productInfo as Ref<ProductInfo>).value?.fob_40_container_price || '-' }}</td>
                      </tr>
                      <tr class="border border-gray-300">
                        <td class="border border-gray-300 p-2">SHIPPING PORT</td>
                        <td class="border border-gray-300 p-2">{{ (productInfo as Ref<ProductInfo>).value?.shipping_port || '-' }}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div class="text-center mt-4 mb-8">
                  <p class="text-base font-normal mb-1">ALL MEASUREMENTS ARE TO BE IN MILLIMETRE'S (MM) AND WEIGHTS IN KILOGRAMS (KG)</p>
                  <p class="text-base font-normal">All Details to be completed fully</p>
                </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      <el-descriptions-item label="面料制造商">
                        {{ (specTables as Ref<SpecTables>).value?.upholstery?.fabric_manufacturer || '-' }}
                      </el-descriptions-item>
                      <el-descriptions-item label="颜色代码">
                        {{ (specTables as Ref<SpecTables>).value?.upholstery?.colour_code || '-' }}
                      </el-descriptions-item>
                      <el-descriptions-item label="皮革等级">
                        {{ (specTables as Ref<SpecTables>).value?.upholstery?.leather_grade || '-' }}
                      </el-descriptions-item>
                      <el-descriptions-item label="每把椅子用料">
                        {{ (specTables as Ref<SpecTables>).value?.upholstery?.usage_per_chair || '-' }}m²
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      ...
                      <el-descriptions-item label="包装箱高度">{{
                          specTables.value.carton?.height
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="纸板类型">{{
                          specTables.value.carton?.board_type
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="每箱数量">{{
                          specTables.value.carton?.items_per_carton
                        }}件
                      </el-descriptions-item>
                      <el-descriptions-item label="箱体体积">{{
                          specTables.value.carton?.carton_volume
                        }}m³
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      <el-descriptions-item label="生产时间">{{
                          specTables.value.logistics?.production_time
                        }}天
                      </el-descriptions-item>
                      <el-descriptions-item label="有效体积">{{
                          specTables.value.logistics?.effective_volume
                        }}m³
                      </el-descriptions-item>
                      <el-descriptions-item label="20尺标准柜装载数量">{{
                          specTables.value.logistics?.loading_quantity_20gp
                        }}件
                      </el-descriptions-item>
                      <el-descriptions-item label="40尺高柜装载数量">{{
                          specTables.value.logistics?.loading_quantity_40hc
                        }}件
                      </el-descriptions-item>
                      <el-descriptions-item label="净重">{{
                          specTables.value.logistics?.net_weight
                        }}kg
                      </el-descriptions-item>
                      <el-descriptions-item label="毛重">{{
                          specTables.value.logistics?.gross_weight
                        }}kg
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      <el-descriptions-item label="座位宽度">{{
                          specTables.value.dimensions?.seat_width
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="座位深度">{{
                          specTables.value.dimensions?.seat_depth
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="座位最小高度">{{
                          specTables.value.dimensions?.seat_height_min
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="座位最大高度">{{
                          specTables.value.dimensions?.seat_height_max
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="靠背宽度">{{
                          specTables.value.dimensions?.back_width
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="靠背高度">{{
                          specTables.value.dimensions?.back_height
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="靠背距座面高度">{{
                          specTables.value.dimensions?.back_height_from_seat
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="整体宽度">{{
                          specTables.value.dimensions?.overall_width
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="整体深度">{{
                          specTables.value.dimensions?.overall_depth
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="整体最小高度">{{
                          specTables.value.dimensions?.overall_height_min
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="整体最大高度">{{
                          specTables.value.dimensions?.overall_height_max
                        }}mm
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      <el-descriptions-item label="材料代码">{{
                          specTables.value.seatInner?.material_code
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="厚度">{{
                          specTables.value.seatInner?.thickness
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="层数">{{
                          specTables.value.seatInner?.layers_count
                        }}层
                      </el-descriptions-item>
                      <el-descriptions-item label="尺寸规格">{{
                          specTables.value.seatInner?.dimensions
                        }}
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      <el-descriptions-item label="材料代码">{{
                          specTables.value.backInner?.material_code
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="厚度">{{
                          specTables.value.backInner?.thickness
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="层数">{{
                          specTables.value.backInner?.layers_count
                        }}层
                      </el-descriptions-item>
                      <el-descriptions-item label="尺寸规格">{{
                          specTables.value.backInner?.dimensions
                        }}
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      ...
                      <el-descriptions-item label="制造商名称">{{
                          specTables.value.backOuter?.manufacturer_name
                        }}
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      ...
                      <el-descriptions-item label="制造商名称">{{
                          specTables.value.seatOuter?.manufacturer_name
                        }}
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      ...
                      <el-descriptions-item label="扶手距座面高度">{{
                          specTables.value.arms?.arm_height_from_seat
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="扶手距地面高度">{{
                          specTables.value.arms?.arm_height_from_floor
                        }}mm
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      ...
                      <el-descriptions-item label="座椅密度">{{
                          specTables.value.foam?.seat_density
                        }}kg/m³
                      </el-descriptions-item>
                      <el-descriptions-item label="靠背密度">{{
                          specTables.value.foam?.back_density
                        }}kg/m³
                      </el-descriptions-item>
                      <el-descriptions-item label="座椅厚度">{{
                          specTables.value.foam?.seat_thickness
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="靠背厚度">{{
                          specTables.value.foam?.back_thickness
                        }}mm
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      ...
                      <el-descriptions-item label="销轴直径">{{
                          specTables.value.castors?.pin_thickness
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="轮子直径">{{
                          specTables.value.castors?.wheel_diameter
                        }}mm
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      ...
                      <el-descriptions-item label="底盘直径">{{
                          specTables.value.base?.size_diameter
                        }}mm
                      </el-descriptions-item>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      ...
                      <el-descriptions-item label="气压等级">{{
                          specTables.value.gasLift?.gas_lift_class
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="外管长度">{{
                          specTables.value.gasLift?.casing_length
                        }}mm
                      </el-descriptions-item>
                      <el-descriptions-item label="行程">{{
                          specTables.value.gasLift?.extension_size
                        }}mm
                      </el-descriptions-item>
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      <el-descriptions-item label="描述">{{
                          specTables.value.gasLiftCover?.description
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="材料">{{
                          specTables.value.gasLiftCover?.material
                        }}
                      </el-descriptions-item>
                ...
                <div class="table-section">
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      <el-descriptions-item label="描述">{{
                          specTables.value.mechanism?.description
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="手柄数量">{{
                          specTables.value.mechanism?.levers_count
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="锁定位置">{{
                          specTables.value.mechanism?.locking_positions
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="型号">{{ specTables.value.mechanism?.model_no }}</el-descriptions-item>
                      <el-descriptions-item label="机构供应商">{{
                          specTables.value.mechanism?.supplier_name
                        }}
                      </el-descriptions-item>
                    </el-descriptions>
                  </div>
                  ...
                  <div class="mt-4">
                    ...
                    <el-descriptions v-else :column="3" border>
                      <el-descriptions-item label="配件编号">{{
                          specTables.value.fittings?.fitting_number
                        }}
                      </el-descriptions-item>
...
import {ref, onMounted, Ref, shallowRef, UnwrapRef} from 'vue'
...
interface SpecTables {
  upholstery: SpecTableItem
  carton: SpecTableItem
  logistics: SpecTableItem
  dimensions: SpecTableItem
  seatInner: SpecTableItem
  backInner: SpecTableItem
  backOuter: SpecTableItem
  seatOuter: SpecTableItem
  arms: SpecTableItem
  foam: SpecTableItem
  castors: SpecTableItem
  base: SpecTableItem
  gasLift: SpecTableItem
  gasLiftCover: SpecTableItem
  mechanism: SpecTableItem
  fittings: SpecTableItem
  [key: string]: SpecTableItem // 添加索引签名
}

const productInfo = shallowRef<ProductInfo>({
  tccode: '',
  supplier: '',
  supplier_code: '',
  supplier_name: '',
...
const specTables = shallowRef<SpecTables>({
  upholstery: {},
  carton: {},
  logistics: {},
  dimensions: {},
...
const editForm = shallowRef<Record<string, any>>({})
...
const handleEdit = (section: keyof SpecTables | 'basic') => {
  ...
  editForm.value = {
    [section]: JSON.parse(JSON.stringify(
      section === 'basic' ? productInfo.value : specTables.value[section as keyof SpecTables]
    ))
  }
}
